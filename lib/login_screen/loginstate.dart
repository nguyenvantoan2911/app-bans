          ...
          child:
            ...
            return Column(
              children: [
                          ...
                          children: [
                            ...
                            CircleAvatar(
                              ...
                              backgroundImage: AssetImage(
                                  'assets/offres/ofres/wishlist.png'),
                            )
                          ],
                        ))
                  ]),
                  ...
                  child: Column(
                    children: [
                      TextField(
                        ...
                        onChanged: (value) {
                          context.read<LoginCubit>().langnghe(value, 'email');
                        },
                ...
                Opacity(
                  opacity:
                      context.read<LoginCubit>().state.isInputValid ? 1.0 : 0.5,
                  child: Container(
                    decoration:
                    ...
                    child: Center(
                        child: ElevatedButton(
                            ...
                            onPressed:
                                context.read<LoginCubit>().state.isInputValid
                                    ? () {
